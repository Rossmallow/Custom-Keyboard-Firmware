...
[0] = LAYOUT(
    ...
    _______, KC_LCTL, KC_LALT,             RCTL_T(KC_SPC),     RCTL_T(KC_SPC),        _______,     KC_RGUI,           _______
),
...
[3] = LAYOUT(
    ...
    KC_NO,   KC_F11, KC_F6, KC_F5, KC_F4, KC_SCRL, US_VALD, KC_MPRV, KC_VOLD, KC_MNXT,          UG_HUED,
