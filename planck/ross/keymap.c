...
[0] = LAYOUT_planck_grid(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,     LALT_T(KC_DEL), LSFT_T(KC_BSPC),  LCTL_T(KC_ESC),  RCTL_T(KC_SPC), RGUI_T(KC_ENT), RALT_T(KC_TAB), KC_RGUI, TG(1)
),
...
[1]= LAYOUT_planck_grid(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_NO,   LT(2,KC_NO), KC_TRNS,      KC_SPC,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
