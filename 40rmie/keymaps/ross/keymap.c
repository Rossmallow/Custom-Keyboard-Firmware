...
[0] = LAYOUT(
    ...
    KC_LSFT, KC_LSFT, KC_Z,    KC_X,        KC_C,        KC_V,        KC_B,           KC_N,   KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,                                   KC_UP,
    		 KC_LCTL, KC_LGUI, KC_LALT,     KC_SPC,      KC_SPC,      RCTL_T(KC_SPC), KC_SPC, KC_SPC,      KC_RALT,     TO(1),       KC_RCTL,                          KC_LEFT, KC_DOWN, KC_RIGHT
),
...
[1] = LAYOUT(
    		 ...
    		 KC_TRNS, KC_TRNS, KC_S,    KC_D,    KC_F,    KC_TRNS, KC_TRNS, KC_J,    KC_K,    KC_L,    KC_TRNS, KC_QUOT, KC_QUOT, KC_QUOT,
...
[2] = LAYOUT(
    		 ...
    		 KC_NUM,  KC_SCLN, KC_P6, KC_P5,   KC_P4,   KC_EQL,  KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO,  KC_NO,  KC_NO, KC_NO,
...
[3] = LAYOUT(
    		 ...
    		 KC_TILD, KC_LCBR, KC_LPRN, KC_ASTR, KC_AMPR, KC_RCBR, KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, KC_BTN4, KC_BTN3,               KC_TRNS, KC_TRNS, KC_TRNS,
