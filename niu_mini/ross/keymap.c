...
├─────┼─────┼─────┼─────┼─────┼─────┴─────┼─────┼─────┼─────┼─────┼─────┤
│Ctrl │ GUI │ Alt │ Del │Bksp │    Esc    │Space│ Ent │ Tab │ GUI │Lyr 1│
└─────┴─────┴─────┴─────┴─────┴───────────┴─────┴─────┴─────┴─────┴─────┘
*/
[0] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,     LALT_T(KC_DEL), LSFT_T(KC_BSPC),     LCTL_T(KC_ESC),   RCTL_T(KC_SPC), RGUI_T(KC_ENT), RALT_T(KC_TAB), KC_RGUI, TG(1)
),
...
[1] = LAYOUT_planck_mit(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_NO,   KC_TRNS, LT(2,KC_NO), KC_TRNS,      KC_SPC,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
...
[2] = LAYOUT_planck_mit(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO
),
...
[3] = LAYOUT_planck_mit(
        ...
        KC_NO,   KC_NO,   KC_NO, KC_PDOT, KC_P0,     KC_MINS,      KC_TRNS, KC_TRNS, KC_TRNS,  KC_NO,  KC_NO
),
...
[4] = LAYOUT_planck_mit(
        ...
        KC_NO,   KC_NO,   KC_NO,   KC_LPRN, KC_RPRN,     KC_UNDS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   KC_NO
),

/* 5: Function/Media
┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
│█████│ F10 │ F9  │ F8  │ F7  │PrScn│RgbUp│RgbPv│VolUp│RgbNx│ClrUp│█████│
├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
...
*/
[5] = LAYOUT_planck_mit(
        KC_NO, KC_F10, KC_F9, KC_F8, KC_F7, KC_PSCR, RGB_VAI, RGB_RMOD, KC_VOLU, RGB_MOD, RGB_HUI, KC_NO,
        ...
        KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO,       KC_NO,      KC_MPLY,  KC_MSTP, KC_MUTE, KC_NO,  RGB_TOG
)
};
